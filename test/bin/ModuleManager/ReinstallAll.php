...
class ReinstallAll extends AbstractModuleManagerTests
{
    ...
    protected function checkMonologRecords(): bool
    {
        ...
        try {
            ...
            //Line 10 [2019-05-22 22:26:23] bfw.DEBUG: FileManager - Create symlink - Use relative path {"target":"../../../vendor//bulton-fr/bfw-hello-world"} []
            $lineNb++;
            ...
            //Line 11 [2019-05-17 09:00:49] bfw.DEBUG: Module - Copy config files {"name":"bfw-hello-world","configPath":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-hello-world","sourceConfigPath":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-hello-world/config/","configFiles":["hello-world.json"]} []
            $lineNb++;
            ...
            //Line 12 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Create directory {"path":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-hello-world"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Create directory');
            $this->checkLogLineContextKeys($lineNb, ['path']);
            $this->checkLogLineContextKeyContain($lineNb, 'path', '/test/install/app/config/bfw-hello-world');

            //Line 13 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Copy file {"source":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-hello-world/config/manifest.json","target":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-hello-world/manifest.json"} []
            $lineNb++;
            ...
            //Line 14 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Copy file {"source":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-hello-world/config/hello-world.json","target":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-hello-world/hello-world.json"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Copy file');
            $this->checkLogLineContextKeys($lineNb, ['source', 'target']);
            ...
            //Line 15 [2019-05-17 09:00:49] bfw.DEBUG: Module - Read module info {"name":"bfw-test-install","path":"/opt/Projects/bfw/bfw/test/install/vendor//bulton-fr/bfw-test-install"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'Module - Read module info');
            $this->checkLogLineContextKeys($lineNb, ['name', 'path']);
            $this->checkLogLineContextKeyEqual($lineNb, 'name', 'bfw-test-install');
            ...
            //Line 16 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Create symlink {"linkTarget":"/opt/Projects/bfw/bfw/test/install/vendor//bulton-fr/bfw-test-install","linkFile":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-test-install"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Create symlink');
            $this->checkLogLineContextKeys($lineNb, ['linkTarget', 'linkFile']);
            ...
            //Line 17 [2019-05-22 22:26:23] bfw.DEBUG: FileManager - Create symlink - Use relative path {"target":"../../../vendor//bulton-fr/bfw-test-install"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Create symlink - Use relative path');
            $this->checkLogLineContextKeys($lineNb, ['target']);
            $this->checkLogLineContextKeyContain($lineNb, 'target', '../../../vendor//bulton-fr/bfw-test-install');

            //Line 18 [2019-05-17 09:00:49] bfw.DEBUG: Module - Copy config files {"name":"bfw-test-install","configPath":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-test-install","sourceConfigPath":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-test-install/config/","configFiles":["test-install.json"]} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'Module - Copy config files');
            $this->checkLogLineContextKeys($lineNb, ['name', 'configPath', 'sourceConfigPath', 'configFiles']);
            $this->checkLogLineContextKeyEqual($lineNb, 'name', 'bfw-test-install');
            ...
            //Line 19 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Create directory {"path":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-test-install"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Create directory');
            $this->checkLogLineContextKeys($lineNb, ['path']);
            $this->checkLogLineContextKeyContain($lineNb, 'path', '/test/install/app/config/bfw-test-install');

            //Line 20 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Copy file {"source":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-test-install/config/manifest.json","target":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-test-install/manifest.json"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Copy file');
            $this->checkLogLineContextKeys($lineNb, ['source', 'target']);
            ...
            //Line 21 [2019-05-17 09:00:49] bfw.DEBUG: FileManager - Copy file {"source":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-test-install/config/test-install.json","target":"/opt/Projects/bfw/bfw/test/install/app/config/bfw-test-install/test-install.json"} []
            $lineNb++;
            $this->checkLogLineMsg($lineNb, 'FileManager - Copy file');
            $this->checkLogLineContextKeys($lineNb, ['source', 'target']);
            ...
            //Line 22 [2019-05-17 09:00:49] bfw.DEBUG: Module - Run install script {"name":"bfw-test-install","installScript":"install.php"} []
            $lineNb++;
