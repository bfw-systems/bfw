...
class EnableAll extends AbstractModuleManagerTests
{
    ...
    protected function checkMonologRecords(): bool
    {
        ...
        try {
            ...
            //{"linkTarget":"/opt/Projects/bfw/bfw/test/install/app/modules/available/bfw-hello-world/src/",
            ...
            $this->checkLogLineContextKeyContain(
                $lineNb,
                'linkTarget',
                '/test/install/app/modules/available/bfw-hello-world/src/'
            );
            $this->checkLogLineContextKeyContain(
                $lineNb,
                'linkFile',
            ...
            //Line 2 [2019-05-22 22:33:19] bfw.DEBUG: FileManager - Create symlink - Use relative path
            //{"target":"../available/bfw-hello-world/src/"} []
            $lineNb++;
            ...
            //Line 3 [2019-05-17 10:03:03] bfw.DEBUG: Module - Read module info
            ...
            //Line 4 [2019-05-17 10:03:03] bfw.DEBUG: FileManager - Create symlink
            ...
            //Line 5 [2019-05-22 22:33:19] bfw.DEBUG: FileManager - Create symlink - Use relative path
