<?php
/**
 * Fichier bootstrap du framework.
 * Repère l'url, détermine si le fichier existe dans web et l'appel
 * Détermine si c'est un fichier d'un module autorisé à être appelé
 * Appel l'initialisation du framework
 * Appel le système de controller qui se charge de la suite.
 * 
...
if(kernelModuleLoad_ctr_test == true)
{
    if(cliMode === true)
    {
        ...
        require_once(path.'cli/'.$file.'.php');
        exit;
    }
